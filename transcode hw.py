...
inputDIR = application_path + "\chainA\\"
...
for filename in os.listdir(inputDIR):
    ...
    cmd = ["ffmpeg.exe", "-hide_banner", "-y", "-hwaccel", "cuda", "-hwaccel_output_format", "cuda", 
    "-i", inputFILE, "-c:v", "hevc_nvenc", "-preset", "medium", "-cq", quality,
     "-vf", "scale_cuda=" + scale, "-c:a", "copy", outputFILE]
    print(" ".join(cmd))
